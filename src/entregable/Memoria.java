...
public class Memoria {
    ...
    private Paginacion memoria[];
    private Paginacion almacenamiento[];
    ...
    public Memoria(int memoriaPrincipalTotal, int memoriaSecundariaTotal, int tamañoPagina, JTextArea textArea) {
        ...
        this.almacenamiento = new Paginacion[cantidadMarcosAlmacenamiento];
        this.memoria = new Paginacion[cantidadMarcos];
    ...
    private void llenarMemoriaVacia() {
        for(int i = 0; i < cantidadMarcos;i++) {
            this.memoria[i] = new Paginacion(i);
        }
    }
    
    private void llenarAlmacenamientoVacio() {
        for(int i = 0; i < cantidadMarcosAlmacenamiento;i++) {
            this.almacenamiento[i] = new Paginacion(i);
        }
    }
    ...
    private void eliminarProcesoMemoria(int posicion) {
        memoria[posicion] = new Paginacion(posicion);
        contadorDisponibles++;
    ...
    private void eliminarProcesoAlmacenamiento(int posicion) {
        almacenamiento[posicion] = new Paginacion(posicion);
    ...
    public void agregarProceso(Proceso proceso) {
        ...
        if (contadorDisponibles >= proceso.getCantidadPaginas()) {
            ...
            textArea.append("• Sin espacio en memoria principal para agregar todas las paginas. Se ha agregado a la memoria secundaria algunas paginas pero no todas.\n");
    ...
    public void quitarUnaPaginaMemoria(Proceso proceso) {
        ...
        textArea.append("• Sin espacio en memoria principal. Se ha movido una(s) pagina(s) del proceso de id "+proceso.getIdProceso()+" a memoria secundaria\n");
        proceso.setPaginasMemoriaSecundaria(proceso.getPaginasMemoriaSecundaria()+1);
        proceso.setPaginasMemoriaPrincipal(proceso.getPaginasMemoriaPrincipal()-1);
        procesoActivoListo(proceso);
        mostrarEspaciosDisponibles();
    ...
    public Paginacion[] getMemoria() {
        return memoria;
    }

    public void setMemoria(Paginacion[] memoria) {
    ...
    public Paginacion[] getAlmacenamiento() {
        return almacenamiento;
    }

    public void setAlmacenamiento(Paginacion[] almacenamiento) {
