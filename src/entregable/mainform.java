...
public class mainform extends javax.swing.JFrame {
    ...
    private void initComponents() {
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(fieldMemoriaSecundaria, javax.swing.GroupLayout.PREFERRED_SIZE, 1, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Agregar Procesos"));

        jLabel1.setText("Nombre del proceso");

        fieldNombreProceso.setText("Tarea 0");
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder("Gestion Memoria"));
        ...
        jLabel14.setText("Tamaño Virtual");
        ...
        jPanel8.setBorder(javax.swing.BorderFactory.createTitledBorder("Memoria Virtual"));
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder("Gestionar Proceso"));
    ...
    private void instalarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_instalarActionPerformed
        ...
        textArea.append("- Iniciando manejo de memoria virtual\n");
    ...
    private void crearProcesoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_crearProcesoActionPerformed
        ...
        if (tamañoProceso <= memoria.getMemoriaPrincipal()+memoria.getMemoriaSecundaria()) {
            ...
            textArea.append("Agregando proceso de tamaño "+tamañoProceso+", id '"+contadorProceso+"', y paginas "+tamañoProceso/memoria.getTamañoPagina()+"\n");
            contadorProceso++;
            labelCantidadProcesos.setText(Integer.toString(contadorProceso));
            fieldNombreProceso.setText("Proceso "+contadorProceso);
            actualizar();
        } else {
            textArea.append("NO HAY MEMORIA PRINCIPAL + la MEMORIA VIRTUAL para crear el proceso.\n");
        }
    ...
    private void suspenderProcesoBloqueadoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_suspenderProcesoBloqueadoActionPerformed
        ...
        if (memoria.getContadorDisponiblesAlmacenamiento() >= procesos[idProceso].getPaginasMemoriaPrincipal()) {
            ...
            textArea.append("* NO HAY MEMORIA VIRTUAL, suspendiendo proceso\n");
        }
    ...
    private void listoProcesoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_listoProcesoActionPerformed
        ...
        if(memoria.getMemoriaPrincipal()+memoria.getMemoriaSecundaria() != 0) {
            ...
            textArea.append("* NO HAY ESPACIOS EN LAS MEMORIAS\n");
        }
        } else {
        ...
        if (pagina <= procesos[idProceso].getCantidadPaginas()) {
            if (desplazamiento <= memoria.getTamañoPagina()) {
                if (procesos[idProceso].getTablaPagina()[pagina].getPrincipal()) {
                    textArea.append(">> La pagina se encuentra en memoria principal.\n");
                    direccionFisica = (procesos[idProceso].getTablaPagina()[pagina].getIdMarco()*memoria.getTamañoPagina())+desplazamiento;
                    textArea.append("> La direccion fisica es: "+Integer.toBinaryString(direccionFisica)+" y su direccion hexadecimal es: 0x"+Integer.toHexString(direccionFisica)+"\n");
                } else {
                    textArea.append(">> Fallo de pagina. Se va a traer la pagina a memoria principal.\n");
                ...
                textArea.append(">> El desplazamiento es mayor al tamaño de pagina\n");
            }
        } else {
            textArea.append(">> Se ha insertado una pagina que no existe\n");
        }
    ...
    private void suspenderProcesoListoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_suspenderProcesoListoActionPerformed
        ...
        if (memoria.getContadorDisponiblesAlmacenamiento() >= procesos[idProceso].getPaginasMemoriaPrincipal()) {
            ...
            textArea.append("* NO HAY ESPACIOS EN LA MEMORIA VIRTUAL PROCESOS SUSPENDIDO\n");
        }
            ...
            try {
                ...
                for(int i = 0; i < procesos.length; i++) {
                    if(procesos[i].getPaginasMemoriaPrincipal() == 1) {
                        this.memoria.quitarUnaPaginaMemoria(procesos[i]);
                        textArea.append("Proceso suspendido de id "+procesos[i].getIdProceso()+" memoria llena de procesos.\n");
    ...
    private void actualizarMemoriaPrincipal() {
        ...
        Paginacion paginasAux[] = memoria.getMemoria();
    ...
    private void actualizarMemoriaSecundaria() {
        ...
        Paginacion paginasAux[] = memoria.getAlmacenamiento();
